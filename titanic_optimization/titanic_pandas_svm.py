"""
File: titanic_pandas_svm.py
Name: Johnson
---------------------------
This file shows how to use pandas and sklearn
packages to build a support vector machine classifier
"""
...
def main():
    ...
    # Submit to Kaggle
    data_test = data_preprocess(TEST_FILE, mode='Test')
    x_test = data_test[feature_names]
    x_test = normalizer.transform(x_test)
    predictions = classifier.predict(x_test)
    out_file(predictions, 'svmGamma0.5.csv')
